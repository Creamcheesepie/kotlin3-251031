...
//        }
    ...
    fun t2() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.get("/api/v1/posts/${targetId}")
            )
            .andDo(MockMvcResultHandlers.print())
    ...
    fun t3() {
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.postDto.authorName").value(author.nickname))
    }
    ...
    fun t9() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.put("/api/v1/posts/${targetId}")
                    .header("Authorization", "Bearer ${author.apiKey}")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        """
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value("${targetId}번 게시물이 수정되었습니다."))
    ...
    fun t10() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.delete("/api/v1/posts/${targetId}")
                    .header("Authorization", "Bearer ${author.apiKey}")
            )
            .andDo(MockMvcResultHandlers.print())
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value("200-1"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value("${targetId}번 게시물이 삭제되었습니다."))
    ...
    @Throws(Exception::class)
    fun t11() {
        val targetId = Int.Companion.MAX_VALUE.toLong()
    ...
    fun t13() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.post("/api/v1/posts")
                    .header("Authorization", "Bearer ${author.apiKey}+2")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        """
                                        {
