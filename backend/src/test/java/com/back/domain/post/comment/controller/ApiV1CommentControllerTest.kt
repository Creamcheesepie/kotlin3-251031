...
class ApiV1CommentControllerTest {
    ...
    fun t3() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.post("/api/v1/posts/${targetPostId}/comments")
                    .header("Authorization", "Bearer ${author.apiKey}")
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.commentDto.authorName").value(author.nickname))
    }
    ...
    fun t4() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.put("/api/v1/posts/${targetPostId}/comments/${targetCommentId}")
                    .header("Authorization", "Bearer ${author.apiKey}")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        """
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value("${targetCommentId}번 댓글이 수정되었습니다."))
    ...
    fun t6() {
        ...
        val resultActions = mvc
            .perform(
                MockMvcRequestBuilders.delete("/api/v1/posts/${targetPostId}/comments/${targetCommentId}")
                    .header("Authorization", "Bearer ${author.apiKey}")
            )
            .andDo(MockMvcResultHandlers.print())
        ...
        resultActions
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.jsonPath("$.resultCode").value("200-1"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.msg").value("${targetCommentId}번 댓글이 삭제되었습니다."))

        // 선택적 검증
        val post = postRepository!!.findById(targetPostId).orElse(null)
        val comment = post!!.findCommentById(targetCommentId).orElse(null)
