...
class ApiV1MemberControllerTest {
        ...
        resultActions.andExpect(
            ResultMatcher { result: MvcResult ->
                ...
                if (apiKeyCookie != null) {
                    Assertions.assertThat(apiKeyCookie.getValue()).isNotBlank()
                }

                val accessTokenCookie = result.getResponse().getCookie("accessToken").getOrThrow()
    ...
    fun t6() {
        ...
        Assertions.assertThat(Ut.jwt.isValid(wrongAccessToken, secretPattern)).isFalse()
        ...
        resultActions
            .andExpect(ResultMatcher { result: MvcResult ->
                val apiKeyCookie = result.getResponse().getCookie("accessToken").getOrThrow()
                Assertions.assertThat<Cookie?>(apiKeyCookie).isNotNull()
                ...
                val newAccessToken = apiKeyCookie.getValue()
